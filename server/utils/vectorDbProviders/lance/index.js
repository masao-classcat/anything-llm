...
const LanceDb = {
  ...
  similarityResponse: async function (client, namespace, queryVector) {
    console.log(">> debug > IN : LanceDb::similarityResponse (server/utils/vectorDbProviders/lance/index.js)");
    ...
    const response = await collection
      .search(queryVector)
      .metricType("cosine")
      .limit(Number(process.env.CC_SEARCH_LIMIT))   // default : 3, original : 5
      .execute();
